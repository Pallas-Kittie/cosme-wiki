var COSME_INGREDIENTS = [
  ...
  },
  {
    ...
    "name_zh": "铁氧化物",
    "common_name_en": "Iron Oxides (CI 77491, 77492, 77499)",
    "common_name_zh": "铁氧化物（CI 77491、77492、77499）",
    "function": ["Colorant", "Pigment"],
    "benefits_en": "Natural inorganic pigments used to color makeup. Available as red iron oxide (CI 77491), yellow iron oxide (CI 77492), and black iron oxide (CI 77499). Provides stable, long-lasting color. Safe for all skin types.",
    "benefits_zh": "天然无机颜料，用于彩妆着色。包括红铁氧化物（CI 77491）、黄铁氧化物（CI 77492）和黑铁氧化物（CI 77499）。提供稳定持久的着色。适合所有肤质。",
    ...
    "supplier_info": "CI 77491 (red), CI 77492 (yellow), CI 77499 (black). Synthetic inorganic oxides.",
    "approval": { "EU": "approved", "USA": "approved", "China": "approved" },
  ...
  },
  {
    ...
    "benefits_en": "Bright, stable green pigment. Provides rich green color for eyeshadows and color cosmetics. Durable and fade-resistant.",
    "benefits_zh": "鲜亮、稳定的绿色颜料。为眼影和彩妆提供丰富的绿色。耐用且抗褪色。",
    "concerns_en": "X = Prohibited in U.S. for cosmetic use under cosmetic pigment regulations. Restricted in EU. Check regional compliance before use.",
    "concerns_zh": "美国化妆品使用被禁止。欧盟有限制。使用前需检查区域合规性。",
    "typical_pct_min": 1,
    "typical_pct_max": 15,
    "comedogenic_rating": 0,
    "allergen": false,
    "supplier": "Suncroma / multiple",
    "supplier_info": "CI 77288. Synthetic inorganic chromium oxide.",
    "approval": { "EU": "restricted", "USA": "prohibited", "China": "approved" },
    "usage_area": { "Face": "X", "Eye": "X", "Lip": "X", "Nail": "NR" },
    "photo": "",
    "color_swatch": "#3d7d3d",
    "added": "2026-05-23",
    "updated": "2026-05-23"
  ...
  },
  {
    ...
    "name_zh": "群青",
    "common_name_en": "Ultramarins (CI 77007)",
    "common_name_zh": "群青（CI 77007）",
    "function": ["Pigment", "Colorant"],
    "benefits_en": "Deep blue pigment derived from lapis lazuli or synthetically produced. Provides intense blue color for eyeshadow. High color strength.",
    "benefits_zh": "源自青金石或合成的深蓝色颜料。为眼影提供强烈的蓝色。着色力强。",
    "concerns_en": "X = Prohibited in U.S. for cosmetics. Restricted in EU. Check regional compliance.",
    "concerns_zh": "美国化妆品使用被禁止。欧盟有限制。检查区域合规性。",
    "typical_pct_min": 0.5,
    "typical_pct_max": 10,
    "comedogenic_rating": 0,
    "allergen": false,
    "supplier": "Suncroma / BASF / multiple",
    "supplier_info": "CI 77007. Synthetic ultramarins (aluminum silicate with lapis-like structure).",
    "approval": { "EU": "restricted", "USA": "prohibited", "China": "approved" },
    "usage_area": { "Face": "X", "Eye": "X", "Lip": "NR", "Nail": "NR" },
    "photo": "",
    "color_swatch": "#0047ab",
